...
static int _locked ## name = 0;                                     \
int Initialize ## name (void)                                       \
{                                                                   \
    return CmtNewTSV (sizeof (datatype), &_locked ## name);         \
}                                                                   \
void Uninitialize ## name (void)                                    \
{                                                                   \
...
void Set ## name (datatype val)                                     \
{                                                                   \
    CmtSetTSV (_locked ## name, (void *)&val);                      \
}                                                                   \
datatype Get ## name (void)                                         \
{                                                                   \
    datatype retval;                                                \
...
int CVIFUNC     CmtWriteTSQData (int userHandle, void *buffer, int numItems, int timeout, int *numItemsFlushed);
...
/* Thread Local Variable */
int CVIFUNC     CmtNewThreadLocalVar (int varSize, void *initialValue, TLVCallbackPtr callback, void *callbackData, int *tlvHandle);
...
int CVIFUNC     CmtSetTSV (int tsvHandle, void *valuePtr);


/* User Lock */
int CVIFUNC CmtNewLock (char *lockName, unsigned int options, int *lockHandle);
